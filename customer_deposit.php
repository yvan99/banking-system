			...
			<div class="container">
				...
				<div class="container-right">
					<div>
						...
						if(isset($_POST['deposit']) AND !empty($_POST['amount'])){
							...
							$amount_deposited = (int)$_POST['amount'];
							$new_balance	=	$old_balance + $amount_deposited;
							mysql_query('UPDATE accounts SET balance = '.$new_balance.' WHERE account_holder = '.$account_holder);
							mysql_query('INSERT INTO operations VALUES(NULL, "deposit", "'.$account_number.'","'.$amount_deposited.'", '.$_SESSION['user_id'].', 1, '.time().')');
							//banksleep
	                        ...
	                        <div style="background:url('sacco.png') no-repeat;background-size:580px; width:500px;border:1px dashed black;padding:2px 40px 80px 40px;font-size:12px;">
					           ...
					           <!-- Motif       ............................../..[Depositor Name]..<br><br> -->
	                        	...
	                        	Amount    	:<b><?php echo $amount_deposited;?></b><br>
	                        	We deposit on account no <b><?php echo $account_number;?></b> an amount of <b><?php echo $amount_deposited;?></b><br>
							...
							<input type="button"value="print"name="printbutton"onclick="printpage()"id="printbutton">
							<?php
								exit();
						}
						$id=($_GET['id']);
						...
						<table>
							<form action="" method="post"> 
	                            ...
	                            <tr>
									...
									<td>
										<lable>
											<input type="text" name="amount" placeholder"Put amount here">
	                            ...
	                            <tr>
									...
									<button type="submit" name="deposit">Deposit</button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="customers.php">Back</a>        
								</td>
								</tr>
							</form>
						</table>	
