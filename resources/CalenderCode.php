<style type="text/css">
            ...
            .ds_cell {
                ...
                font-size: 15px;
                text-align: center;
                font-family: monospace, fantasy, cursive, Terminal;;
                padding: 5px;
				font-weight: bold;
                cursor: pointer;
            }
    ...
    <script type="text/javascript">
        ...
        function ds_template_main_above(t) {
            return '<table cellpadding="3" cellspacing="1" class="ds_tbl">'
                + '<tr>'
                + '<td class="ds_head" style="cursor: pointer;color:yellow;" onclick="ds_py();">&lt;&lt;</td>'
                + '<td class="ds_head" style="cursor: pointer;color:yellow;"onclick="ds_pm();">&lt;</td>'
                + '<td class="ds_head" style="cursor: pointer;color:yellow;" onclick="ds_hi();" colspan="3">CLOSE</td>'
                + '<td class="ds_head" style="cursor: pointer;color:yellow;" onclick="ds_nm();">&gt;</td>'
                + '<td class="ds_head" style="cursor: pointer;color:yellow;" onclick="ds_ny();">&gt;&gt;</td>'
        ...
        function ds_template_day(y, m, d) {
            return '<td class="ds_cell" onclick="ds_onclick(' + y + ',' + m
                + ',' + d + ')">' + d + '</td>';
